 ...
 * 2.create a checkout form with card element (card elements contains: card number, card expiration date,cvs,zip code )
 * 3.create account an Stripe and get the publishable key pk.
